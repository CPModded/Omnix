/**
 * ====================================================================
 * CONTRÔLEUR D'AUTHENTIFICATION OAUTH2 (FORÇAGE ABSOLU HTTP)
 * ====================================================================
 */
...
export class AuthController {
  ...
  static async handleCallback(req: Request, res: Response) {
    ...
    try {
      ...
      // CORRECTIF DE FORCE HTTP : On utilise CONFIG.CLIENT_URL pour forcer l'adresse absolue sans HTTPS
      ...
      return res.send(`
        ...
        <body>
          ...
          <script>
            ...
            // Redirection absolue forcée en HTTP
            setTimeout(() => {
