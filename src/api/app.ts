...
app.use(express.json({ limit: '5mb', verify: (req: Request & { rawBody?: Buffer }, _res: Response, buf: Buffer) => { if (req.originalUrl === '/api/payments/webhook') req.rawBody = Buffer.from(buf); } }));
