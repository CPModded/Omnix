...
const schema = new Schema<IPlatformEvent>({
  type: { type: String, enum: ['user_registered','user_login','guild_added','guild_removed','ai_request','ai_error','payment','subscription','member_joined','member_left','command_executed','command_error'], required: true, index: true },
