...
export default {
  ...
  async execute(
    ...
    try {
      ...
      // getGuildConfig retourne directement le document GuildConfig.
      // L'ancien code cherchait result.config, ce qui rendait la
      // configuration artificiellement introuvable pour /ticket.
